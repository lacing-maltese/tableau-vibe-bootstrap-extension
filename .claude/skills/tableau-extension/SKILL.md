...
description: Scaffold a new Tableau dashboard extension — manifest, panel HTML, config dialog, and Extensions API wiring. Captures hard-won lessons from production deployments on Tableau Cloud.
allowed-tools: Read, Write, Edit, Bash(git *), Bash(mkdir *), Bash(ls *), Bash(cp *), WebFetch
argument-hint: "[extension name and brief description of what it does]"
---
